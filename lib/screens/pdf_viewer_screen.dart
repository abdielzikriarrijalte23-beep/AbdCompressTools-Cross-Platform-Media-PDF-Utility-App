...
import 'package:abdsukapdf/widgets/web_pdf_viewer.dart'
    if (dart.library.html) 'package:abdsukapdf/widgets/web_pdf_viewer_web.dart';
import 'package:abdsukapdf/services/file_history_service.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _isNightMode
          ...
          : (isDark ? const Color(0xFF101817) : const Color(0xFFF6F8F7)),
      appBar: kIsWeb
          ? null
          : AppBar(
              backgroundColor: _isNightMode

...
class AppConfig {
  static const String appTitle = 'ABdCompressTools';
  static const String appVersion = '1.0.0';
  static const Color primaryColor = Color(0xFF00796B);
  static const Color darkRedColor = Color(0xFF003D36);
  ...
  static ThemeData _getLightThemeData() {
    const lightBgColor = Color(0xFFF8F9FA);
    const lightSurfaceColor = Color(0xFFFFFFFF);
    const lightSecondaryColor = Color(0xFF4A90E2);
    return ThemeData(
      useMaterial3: true,
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        selectedIconTheme: const IconThemeData(color: Color(0xFF00796B)),
        ...
        indicatorColor: const Color(0xFF00796B).withValues(alpha: 0.1),
      ),
    );
  }
  ...
  static ThemeData _getDarkThemeData() {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: const Color(0xFF101817),
        contentPadding: const EdgeInsets.symmetric(
          horizontal: paddingLarge,
          vertical: paddingBase,
        ),

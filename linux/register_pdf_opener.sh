...
# This script registers ABdSukaPDF as the default PDF opener on Linux systems
...
echo "Registering ABdSukaPDF as PDF opener..."
...
if [ -f "$SCRIPT_DIR/../asset/app_img/ABdSukaPDF.png" ]; then
    mkdir -p "$ICONS_DIR"
    cp "$SCRIPT_DIR/../asset/app_img/ABdSukaPDF.png" "$ICONS_DIR/$APP_NAME.png"
...
echo ""
echo "✓ ABdSukaPDF registered as PDF opener successfully!"
echo ""
